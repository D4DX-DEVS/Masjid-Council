...
const LoadingState = () => (
  <ReaderShell>
    ...
    <div className="mt-8 grid gap-8 lg:grid-cols-[260px_minmax(0,1fr)]">
      ...
      <div className="space-y-3 rounded-2xl bg-white p-6 shadow-sm sm:p-8">
      ...
      return (
        <li key={chapter.slug}>
          <Link
            ...
            className={`flex gap-2.5 rounded-lg px-3 py-2 text-sm leading-snug transition-colors ${
              active
          ...
          >
            <span className={`shrink-0 tabular-nums ${active ? 'text-[#1F6B3A]' : 'text-gray-400'}`}>
              {index + 1}.
            </span>
...
const PublicationReader = () => {
  ...
  const safeBody = useMemo(
    () => (chapter ? DOMPurify.sanitize(chapter.bodyHtml, { ADD_ATTR: ['target'] }) : ''),
    [chapter]
  );
    ...
    <ReaderShell>
      ...
      <div className="mt-6 grid gap-6 lg:mt-8 lg:grid-cols-[264px_minmax(0,1fr)] lg:gap-10">
        ...
        <div className="lg:hidden">
          ...
          {tocOpen && (
            <div className="mt-2 max-h-80 overflow-y-auto rounded-xl border border-gray-200 bg-white p-2 shadow-lg">
              <ChapterList
                chapters={chapters}
        ...
        <article ref={articleRef} className="scroll-mt-24">
          <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-gray-100 sm:p-8 lg:p-10">
            <h2
