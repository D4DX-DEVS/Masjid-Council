  ...
  pages: [
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 16, label: "സഹായം ആവശ്യമായ ഇനം", type: "select", required: true, enabled: true, options: ["വീട് റിപ്പയർ", "വിവാഹം", "ചികിത്സ", "വിദ്യാഭ്യാസം", "മറ്റുള്ളവ"] },
    ...
    },
    {
      ...
      fields: [
        ...
        // ponytail: text (not number) — account numbers keep leading zeros
        { id: 43, label: "ബാങ്ക് അക്കൗണ്ട് നമ്പർ", type: "text", required: true, enabled: true },
        { id: 44, label: "IFSC കോഡ്", type: "text", required: true, enabled: true },
        { id: 45, label: "ബാങ്കിന്റെ പേര്", type: "text", required: true, enabled: true },
  ...
  pages: [
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 25, label: "ബാങ്ക് അക്കൗണ്ട് നമ്പർ", type: "text", required: true, enabled: true },
        { id: 26, label: "IFSC കോഡ്", type: "text", required: true, enabled: true },
        { id: 27, label: "ബാങ്കിന്റെ പേര്", type: "text", required: true, enabled: true },
